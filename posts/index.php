...
if(isset($_POST['submit_poid']))
{
    if(isset($_POST['id'])){
        $idpostan=$_POST['id'];
        $theposth= Posts::allidthreads("post_id", "$idpostan",'created_at',"DESC");
        $mrowpost=$theposth->fetch_object();
        $cr_post_ans= Users::findBythread('nickname', $mrowpost->an_creator_nick);
        $_SESSION['anpost']=  '<p style= "text-align: center; background-color:#ecf0f1;">' . ' <img src="http://localhost:89/forum_f/assets/images/users/' . $cr_post_ans->image_user . '" style="width:30px;">' . ' Answer To Post ' . "of $mrowpost->an_creator_nick" . " $mrowpost->content" . " </p>" . "<br>";
    }
    ...
    <div class="panel panel-primary">
     ...
     <div class="media-body">
        ...
        <div class="panel-body">
            ...
            <form action="../scripts/post_create.php"  method="post" id="mainForm">
                
                <div class="form-group">
                    <textarea class='form-control' name="content" id="textarea">Content-post.</textarea>
                </div>   
                <?php if (isset($_SESSION['anpost'])):?>

                    <button type="submit" class="btn btn-primary btn-block">Answer To Post</button>
                <?php else :?>
